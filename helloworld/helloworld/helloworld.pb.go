...
func (x *HelloRequest) SetName(value string) error {
	value, err := privacy_go.PermissionedEncrypt("HelloRequest", "Name", value)
	if err != nil {
		return err
	}
	x.Name = value
...
func (x *HelloReply) SetMessage(value string) error {
	value, err := privacy_go.PermissionedEncrypt("HelloReply", "Message", value)
	if err != nil {
		return err
	}
	x.Message = value
